export const NG_LGAS: Record<string, string[]> = {
  // Keys are the canonical state names — used as the single source of truth for NG_STATES too.
  'Abia': [
...
// Derived from NG_LGAS keys — single source of truth for all Nigerian states.
export const NG_STATES: string[] = Object.keys(NG_LGAS);
